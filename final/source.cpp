...
void sortEntire(int sub) {
	...
	if (sub == 1) {
		...
		sort01.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 2 - BASIC STRUCTURES: SETS, FUNCTIONS, SEQUENCES, SUMS, AND MATRICES";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head2 = sort02.getHead();
		sort02.bubbleSort(head2);
		sort02.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 3 - ALGORITHMS";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head3 = sort03.getHead();
		sort03.bubbleSort(head3);
		sort03.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 4 - NUMBER THEORY AND CRYPTOLOGY";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head4 = sort04.getHead();
		sort04.bubbleSort(head4);
		sort04.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 5 - INDUCTION AND RECURSION";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head5 = sort05.getHead();
		sort05.bubbleSort(head5);
		sort05.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 6 - COUNTING";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head6 = sort06.getHead();
		sort06.bubbleSort(head6);
		sort06.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 7 - DISCRETE PROBABILITY";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head7 = sort07.getHead();
		sort07.bubbleSort(head7);
		sort07.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 9 - RELATIONS";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head9 = sort09.getHead();
		sort09.bubbleSort(head9);
		sort09.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 10 - GRAPHS";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head10 = sort10.getHead();
		sort10.bubbleSort(head10);
		sort10.print();
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		cout << "CHAPTER 11 - TREES";
		cout << "\n----------------------------------------------------------------------------------------------------\n";
		Node*head11 = sort11.getHead();
		sort11.bubbleSort(head11);
		sort11.print();
...
void sortSections(int numSec) {
	...
	if (numSec == 2) {
		...
		if (sel == 1) {
			...
			cout << "\n----------------------------------------------------------------------------------------------------" << endl;
			cout << "PRINTING OUT SORTED SECTIONS INDIVIDUALLY" << endl;
			cout << "----------------------------------------------------------------------------------------------------" << endl;
			while (head != NULL) {
				secId = head->value;
		...
		if (sel == 2) {
			...
			Node*head = secList->getHead();
			cout << "\n----------------------------------------------------------------------------------------------------" << endl;
			cout << "PRINTING OUT SORTED TERMS OF ALL SELECTED SECTIONS" << endl;
			cout << "----------------------------------------------------------------------------------------------------" << endl;
			while (head != NULL) {
				secId = head->value;
				addSortSel(secId);
...
void view(int *userNum) {
    ...
    if (VDSelection == 5) {
        cout << "\n----------------------------------------------------------------------------------------------------";
        cout << "\nUF COT3100 - APPLICATIONS OF DISCRETE MATHEMATICS ";
        cout << "\n----------------------------------------------------------------------------------------------------\n";
        definition.print();
        *userNum = 3;
    }
                ...
                if (cin.fail() || !(ch1 >= 1 && ch1 <= 7) && !(ch1 >= 9 && ch1 <= 11)) {
                    ...
                    if (choice3 == 1) {
                        ...
                        if (cin.fail() || !(ch3 >= 1 && ch3 <= 7) && !(ch3 >= 9 && ch3 <= 11)) {
                            ...
                            cout << "\nSHOWING CHAPTERS " << ch1 << ", " << ch2 << ", AND " << ch3 << endl;
                            cout << "----------------------------------------------------------------------------------------------------" << endl;
                    ...
                    if (choice3 == 2) {
                        cout << "\nSHOWING CHAPTERS " << ch1 << " AND " << ch2 << endl;
                        cout << "----------------------------------------------------------------------------------------------------" << endl;
                        if (chList->contains("1")) def01.print();
                        if (chList->contains("2")) def02.print();
                        if (chList->contains("3")) def03.print();
...
void viewSelSec(int numSec) {
	...
	if (numSec == 1) {
		...
		if (sectionIdList.contains(sec1)) {
			cout << "\n----------------------------------------------------------------------------------------------------" << endl;
			cout << "SHOWING SELECTED SECTION" << endl;
			cout << "----------------------------------------------------------------------------------------------------" << endl;
			viewPrintSec(sec1);
		}
		else { 
	...
	if (numSec == 2) {
		...
		if (sectionIdList.contains(sec1)) {
			...
			Node*head = secList->getHead();
			cout << "\n----------------------------------------------------------------------------------------------------" << endl;
			cout << "SHOWING SELECTED SECTIONS" << endl;
			cout << "----------------------------------------------------------------------------------------------------" << endl;
			while (head != NULL) {
				secId = head->value;
				viewPrintSec(secId);
...
void toc(int *userNum) {
    ...
    cout << endl;
    cout << "NOTE: Chapter 8 is not covered in Spring 2018" << endl;
    cout << endl;
    *userNum = 0;
}
